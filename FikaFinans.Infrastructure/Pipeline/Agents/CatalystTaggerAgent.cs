...
public sealed class CatalystTaggerAgent : ICatalystTaggerAgent
{
    private readonly IPathsService _paths;
    private readonly IFundCatalystLlmClient _llm;

    public CatalystTaggerAgent(IPathsService paths, IFundCatalystLlmClient llm)
    {
    ...
    {
        var alignedPath = _paths.MacroAlignerOutput(isoWeek, runId);
        ...
        WriteJson(_paths.CatalystTaggerOutput(isoWeek, runId), output);
        return output;
    }
