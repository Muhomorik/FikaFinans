...
/// Copied verbatim, including <see cref="GetLatestNavDateAsync"/> which has no consumer on this
/// side yet — it belongs to the snapshot service, not yet mirrored. Keep it in sync with the
/// original rather than trimming it.
/// </remarks>
